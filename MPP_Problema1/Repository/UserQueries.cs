...
namespace MPP_Problema1
{
    public static class Queries
    {
        ...
        {
            public static NpgsqlCommand GetAll(NpgsqlConnection connection) => new NpgsqlCommand(string.Format("SELECT * FROM {0}", DbConstants.Tables.Flights), connection);

        }
        public static class FlightTicketQueries
        {

        }
        public static class FlightClientQueries
        {
